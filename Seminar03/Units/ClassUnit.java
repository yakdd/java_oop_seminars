...
public abstract class ClassUnit implements InterfaceUnit {
    ...
    protected String typeUnit; // тип юнита
    ...
    // parameters order: type, attack, defence, damage[], hp, speed, name
    public ClassUnit(String typeUnit, int attack, int defence, int[] damage, float hp, int speed, String name) {
        this.hp = hp;
        this.speed = speed;
        this.damage = damage;
