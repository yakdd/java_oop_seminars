...
public class Main {
    ...
    private static void init() {
        ...
        for (int i = 0; i < GANG_SIZE; i++) {
            ...
            switch (num) {
                case 0:
                    darkSide.add(new Peasant(getName(), num, i));
                    whiteSide.add(new Peasant(getName(), GANG_SIZE - 1 - num, i));
                    break;
                case 1:
                    darkSide.add(new Wizard(getName(), num, i));
                    whiteSide.add(new Monk(getName(), GANG_SIZE - 1 - num, i));
                    break;
                case 2:
                    darkSide.add(new Sniper(getName(), num, i));
                    whiteSide.add(new XBowMan(getName(), GANG_SIZE - 1 - num, i));
                    break;
                case 3:
                    darkSide.add(new Robber(getName(), num, i));
                    whiteSide.add(new LanceBearer(getName(), GANG_SIZE - 1 - num, i));
                    break;
            }
        }
